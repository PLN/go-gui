...
description: Which sibling repos require a go-gui version bump on release. Use when cutting a go-gui release, propagating a new tag to consumers, or deciding whether a repo is an upstream or downstream dependency.
---
